...
export const PRODUTOS_INICIAIS: Produto[] = [
  ...
  { id: 15, nome: "Nimesulida gotas 50mg/ml Scaflogin 15ml", preco: 8.00, precoOriginal: 7.00, categoria: "Analgésicos", emoji: "💊", desc: "Anti-inflamatório gotas", promocao: { quantidade: 2, precoTotal: 8.00, descricao: "🔥 PROMOÇÃO: LEVE 2 por R$8,00" } },
  ...
  { id: 32, nome: "Losartana potássica 50mg – Eurofarma", preco: 10.00, precoOriginal: 6.00, categoria: "Anti-hipertensivos", emoji: "❤️", desc: "Para pressão alta", promocao: { quantidade: 3, precoTotal: 10.00, descricao: "🔥 PROMOÇÃO: LEVE 3 por R$10,00" } },
